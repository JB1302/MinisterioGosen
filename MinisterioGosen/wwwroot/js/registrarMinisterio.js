document.addEventListener("DOMContentLoaded", function () {
    const buscarMinisterio = document.getElementById("buscarMinisterio");
    const tablaMinisterios = document.getElementById("tablaMinisterios");

    if (buscarMinisterio && tablaMinisterios) {

        buscarMinisterio.addEventListener("keyup", function () {

            const filtro = this.value.toLowerCase();
            const filas = tablaMinisterios.querySelectorAll("tbody tr");
...
function confirmarSacarUsuarioMinisterio(boton) {
    ...
    Swal.fire({
        ...
        text: "¿Desea sacar a esta persona de " + nombre + "?",
        icon: "warning",
